	...
	<div class='col-xs-12 col-md-12'>
			<div class='row'>
				<div id='shop' class='box'>
						<div class='box-title'>
								<h4>Login Administrator <i class='fa fa-key pull-right'></i></h4>
						</div>
									...
									<div class='row'>
										<div class='col-md-12'>
											<div class='text-justify'>
												Hubungi <strong>Administrator</strong> untuk login disini !
											</div>
											<div class='col-md-12 col-xs-12'>
												<div class='col-md-6 col-md-offset-3'>
												<h3 class='text-center'>Punya Akun? Silahkan Login Disini !</h3>
