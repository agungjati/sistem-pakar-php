<?php
	...
	switch ($_POST['type']) {
		...
		case 'LoadQuestion':
			...
			$b = mysqli_query($connect, "SELECT * FROM tbl_identifikasi $where ORDER BY id_identifikasi ASC LIMIT 0,1 ");
		...
		case 'new':			
			...
			if($_POST['pilih'] == 0){
				$sql2 = mysqli_query($connect, "SELECT dua as aturan FROM tbl_aturan_tidak WHERE satu ='".$_POST['id_identifikasi']."' LIMIT 1");
				...
				$sql = mysqli_query($connect, "INSERT INTO tbl_temp SET 
